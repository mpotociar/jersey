...
public class SecurityHelperTest {
    ...
    public void testFilteringScopes() throws Exception {
        ...
        annotations = new Annotation[] {Custom.INSTANCE, Custom.INSTANCE};
        assertThat(SecurityHelper.getFilteringScopes(annotations), equalTo(Collections.<String>emptySet()));

        // Mixed.
        annotations = new Annotation[] {Custom.INSTANCE, SecurityAnnotations
                .rolesAllowed("manager"), Custom.INSTANCE};
