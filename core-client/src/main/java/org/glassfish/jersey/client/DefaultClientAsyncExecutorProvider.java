 ...
 */
@DefaultClientAsyncExecutorProvider.ClientAsyncExecutor
class DefaultClientAsyncExecutorProvider extends ThreadPoolExecutorProvider {
    ...
    @Inherited
    @Qualifier
    public static @interface ClientAsyncExecutor {

        public static final ClientAsyncExecutor INSTANCE = new ClientAsyncExecutorImpl();
    }

    @SuppressWarnings("ClassExplicitlyAnnotation")
    private static class ClientAsyncExecutorImpl extends AnnotationLiteral<ClientAsyncExecutor> implements ClientAsyncExecutor {
    }
